"""
AS_genebank_pocket.py

Description:
This script generates GenBank annotations for protein pocket residues. It parses input files,
identifies residues close to pocket atoms, and writes the annotated sequence to a GenBank file.

Usage:
    python AS_genebank_pocket.py <summary_csv> [-t <threshold>] [-o <output_file>]

Arguments:
    summary_csv   : Full path to the summary CSV file (e.g., './TLE3_reduce_summary.csv').
    -t, --threshold : (Optional) Threshold distance for residue-pocket proximity (default: 4.5).
    -o, --output-file : (Optional) Output GenBank file name. If not provided, the script will use '<base-name>_pockets.gbk'.

Example:
    python AS_genebank_pocket.py ./TLE3_reduce_summary.csv -t 5.0 -o TLE3_pockets.gbk
